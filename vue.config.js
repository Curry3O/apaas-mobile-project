...
module.exports = {
  ...
  chainWebpack: (config) => {
    ...
    svgRule
      ...
      .add(resolve('./node_modules/_@x-apaas_x-dcloud-page-mobile@0.3.3@@x-apaas/x-dcloud-page-mobile/lib/assets/icon'))
      .add(resolve('./node_modules/_@x-apaas_x-dcloud-page-mobile@0.2.0-rc.0@@x-apaas/x-dcloud-page-mobile/lib/assets/icon'))
